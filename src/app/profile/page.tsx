        ...
        <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-6 sm:p-10">
          <div className="flex flex-col sm:flex-row items-center">
            ...
            <div className="text-center sm:text-left">
              ...
              <p className="text-indigo-100 text-sm mt-1">Member since {user?.joinDate}</p>
            </div>
          </div>
        </div>
          ...
          {activeTab === 'orders' && (
            <div>
              ...
              <div className="bg-gray-50 p-8 rounded-lg text-center">
                ...
                <h3 className="mt-4 text-gray-800 text-lg font-medium">No orders yet</h3>
          ...
          {activeTab === 'wishlist' && (
            <div>
              ...
              <div className="bg-gray-50 p-8 rounded-lg text-center">
                ...
                <h3 className="mt-4 text-gray-800 text-lg font-medium">Your wishlist is empty</h3>
                <p className="mt-1 text-gray-500">Add items to your wishlist to keep track of things you like</p>
                <button className="mt-4 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                  Explore Products
                </button>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 border rounded-md">
                  ...
                  <div className="relative inline-block w-12 h-6 transition duration-200 ease-in-out rounded-full cursor-pointer">
                    <input type="checkbox" name="toggle" id="toggle" className="absolute w-6 h-6 transition duration-200 ease-in-out transform bg-white border-4 rounded-full appearance-none cursor-pointer peer border-gray-300 checked:border-indigo-600 checked:translate-x-6" />
                    <label htmlFor="toggle" className="block w-full h-full bg-gray-300 rounded-full cursor-pointer peer-checked:bg-indigo-600"></label>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 border rounded-md">
                  ...
                  <div className="relative inline-block w-12 h-6 transition duration-200 ease-in-out rounded-full cursor-pointer">
                    <input type="checkbox" name="toggle2" id="toggle2" className="absolute w-6 h-6 transition duration-200 ease-in-out transform bg-white border-4 rounded-full appearance-none cursor-pointer peer border-gray-300 checked:border-indigo-600 checked:translate-x-6" />
                    <label htmlFor="toggle2" className="block w-full h-full bg-gray-300 rounded-full cursor-pointer peer-checked:bg-indigo-600"></label>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 border rounded-md">
                  ...
                  <div className="relative inline-block w-12 h-6 transition duration-200 ease-in-out rounded-full cursor-pointer">
                    <input type="checkbox" name="toggle3" id="toggle3" checked className="absolute w-6 h-6 transition duration-200 ease-in-out transform bg-white border-4 rounded-full appearance-none cursor-pointer peer border-gray-300 checked:border-indigo-600 checked:translate-x-6" />
                    <label htmlFor="toggle3" className="block w-full h-full bg-gray-300 rounded-full cursor-pointer peer-checked:bg-indigo-600"></label>
                  </div>
                </div>
              </div>
